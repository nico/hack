...
X(XML_ELEMENT_NODE);       X(XML_ATTRIBUTE_NODE);     X(XML_TEXT_NODE);
X(XML_CDATA_SECTION_NODE); X(XML_ENTITY_REF_NODE);    X(XML_ENTITY_NODE);
X(XML_PI_NODE);            X(XML_COMMENT_NODE);       X(XML_DOCUMENT_NODE);
X(XML_DOCUMENT_TYPE_NODE); X(XML_DOCUMENT_FRAG_NODE); X(XML_NOTATION_NODE);
X(XML_HTML_DOCUMENT_NODE); X(XML_DTD_NODE);           X(XML_ELEMENT_DECL);
X(XML_ATTRIBUTE_DECL);     X(XML_ENTITY_DECL);        X(XML_NAMESPACE_DECL);
X(XML_XINCLUDE_START);     X(XML_XINCLUDE_END);       X(XML_DOCB_DOCUMENT_NODE);
#undef X
