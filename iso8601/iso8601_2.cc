...
int main() {
  ...
  if (d->date_style != DateStyle::YearMonthDay || d->year != 2020 || d->month != 5 || d->time_style != TimeStyle::HourMinutes || d->hours != 23 || d->minutes != 59 || d->timezone_style != TimezoneStyle::None) exit(20);
